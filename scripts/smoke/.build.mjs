...
async function expectApiError(name, fn, code, msg) {
  try {
    await fn();
    ...
    const msgOk = msg === void 0 || err.message === msg;
...
async function main() {
  ...
  console.log("\n\u3010\u6279\u6B213\u3011Actor \u4E00\u81F4\u6027\uFF1A\u4E0D\u5141\u8BB8\u4EE5\u4ED6\u4EBA\u8EAB\u4EFD\u8BFB\u5199\uFF0813 \u53F7 \xA75.3\uFF09");
  ...
  await expectApiError(
    "\u4EE5\u4ED6\u4EBA\u8EAB\u4EFD\u521B\u5EFA\u8BD5\u5377 \u2192 403",
    () => api.draft.create(bob.id, { draftName: "x" }),
    ApiCode.NO_PERMISSION
  );
  await expectApiError(
    "\u4EE5\u4ED6\u4EBA\u8EAB\u4EFD\u67E5\u770B\u7B54\u9898\u8BB0\u5F55 \u2192 403",
